...
void CSystemData::Save()
{
	...
	else
	{
		...
		fprintf_s(out, "DATA_SET		%lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf\n", dDataset[0], dDataset[1], dDataset[2], dDataset[3], dDataset[4], dDataset[5], dDataset[6], dDataset[7], dDataset[8], dDataset[9], dDataset[10], dDataset[11], dDataset[12]);
#endif
		...
		fprintf_s(out, "RS_COMM_PORT	%d %d %d %d %d %d %d %d %d %d \n", iCommPort[0], iCommPort[1], iCommPort[2], iCommPort[3], iCommPort[4], iCommPort[5], iCommPort[6], iCommPort[7], iCommPort[8], iCommPort[9]);
		fprintf_s(out, "RS_COMM_BAUD	%d %d %d %d %d %d %d %d %d %d \n", iBaudRate[0], iBaudRate[1], iBaudRate[2], iBaudRate[3], iBaudRate[4], iBaudRate[5], iBaudRate[6], iBaudRate[7], iBaudRate[8], iBaudRate[9]);
...
//#else
//
//		fprintf_s(out, "RS_COMM_PORT	%d %d %d %d %d %d %d %d %d \n", iCommPort[0], iCommPort[1], iCommPort[2], iCommPort[3], iCommPort[4], iCommPort[5], iCommPort[6], iCommPort[7], iCommPort[8]);
	...
	if(!fopen_s(&in, fileName,"r"))
	{
		while (1)
		{
			...
			else if(strcmp(Title, "DATA_SET")==0)
			{
				...
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf",		Title, 499, &dDataset[0], &dDataset[1], &dDataset[2], &dDataset[3], &dDataset[4], &dDataset[5], &dDataset[6], &dDataset[7], &dDataset[8], &dDataset[9], &dDataset[10], &dDataset[11], &dDataset[12]);
#endif
			}
			else if(strcmp(Title, "PASSWORD")==0)
			{
			...
			{
				sscanf_s(Line, "%s %d %d %d %d %d %d %d %d %d %d", Title, 499, &iCommPort[0], &iCommPort[1], &iCommPort[2], &iCommPort[3], &iCommPort[4], &iCommPort[5], &iCommPort[6], &iCommPort[7], &iCommPort[8], &iCommPort[9]);
//#if (__MACHINE_MODEL == MACHINE_1ST)
...
//#else
//
//				sscanf_s(Line, "%s %d %d %d %d %d %d %d %d %d",						Title, 499, &iCommPort[0], &iCommPort[1], &iCommPort[2], &iCommPort[3], &iCommPort[4], &iCommPort[5], &iCommPort[6], &iCommPort[7], &iCommPort[8]);
//#endif
			}
			else if( strcmp(Title, "RS_COMM_BAUD") == 0 )
			{
				sscanf_s(Line, "%s %d %d %d %d %d %d %d",						Title, 499, &iBaudRate[0], &iBaudRate[1], &iBaudRate[2], &iBaudRate[3], &iBaudRate[4], &iBaudRate[5], &iBaudRate[6], &iBaudRate[7], &iBaudRate[8], &iBaudRate[8]);
			}
...
void CModelData::Save()
{
	...
	else
	{
		...
		for(int iNo = 0; iNo  < MAX_POS_NO; iNo++ ) 
		{
			...
			fprintf_s(out, "%s       %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf\n", TitleStr.GetBuffer(999),
				axis[0].pos[iNo], 
				axis[1].pos[iNo], axis[2].pos[iNo], axis[3].pos[iNo], axis[4].pos[iNo], axis[5].pos[iNo],
				axis[6].pos[iNo], axis[7].pos[iNo], axis[8].pos[iNo], axis[9].pos[iNo], axis[10].pos[iNo],
				axis[11].pos[iNo], axis[12].pos[iNo], axis[13].pos[iNo], axis[14].pos[iNo], axis[15].pos[iNo],
				axis[16].pos[iNo], axis[17].pos[iNo], axis[18].pos[iNo], axis[19].pos[iNo], axis[20].pos[iNo]
#endif
		...
		fprintf_s(out, "LENS_OK_LIMIT		%lf %lf %lf %lf %lf %lf\n"
			, axis[Motor_Lens_X].m_dLimit_OK, axis[Motor_Lens_Y].m_dLimit_OK, axis[Motor_Lens_Z].m_dLimit_OK
			, axis[Motor_Lens_Xt].m_dLimit_OK, axis[Motor_Lens_Yt].m_dLimit_OK, axis[Motor_Lens_TH].m_dLimit_OK);
		fprintf_s(out, "LENS_ERR_LIMIT		%lf %lf %lf %lf %lf %lf\n"
			, axis[Motor_Lens_X].m_dLimit_Err, axis[Motor_Lens_Y].m_dLimit_Err, axis[Motor_Lens_Z].m_dLimit_Err
			, axis[Motor_Lens_Xt].m_dLimit_Err, axis[Motor_Lens_Yt].m_dLimit_Err, axis[Motor_Lens_TH].m_dLimit_Err);

		fprintf_s(out, "PCB_OK_LIMIT		%lf %lf %lf %lf %lf %lf %lf\n"
			, axis[Motor_PCB_X].m_dLimit_OK, axis[Motor_PCB_Y].m_dLimit_OK, axis[Motor_PCB_Z].m_dLimit_OK
			, axis[Motor_PCB_TH].m_dLimit_OK, axis[Motor_PCB_Xt].m_dLimit_OK, axis[Motor_PCB_Yt].m_dLimit_OK, axis[Motor_Insp_X].m_dLimit_OK);
		fprintf_s(out, "PCB_ERR_LIMIT		%lf %lf %lf %lf %lf %lf %lf\n"
			, axis[Motor_PCB_X].m_dLimit_Err, axis[Motor_PCB_Y].m_dLimit_Err, axis[Motor_PCB_Z].m_dLimit_Err,
			axis[Motor_PCB_TH].m_dLimit_Err, axis[Motor_PCB_Xt].m_dLimit_Err, axis[Motor_PCB_Yt].m_dLimit_Err, axis[Motor_Insp_X].m_dLimit_Err);
...
void CModelData::Load()
{
	...
	if(!fopen_s(&in, fileName,"r"))
	{
		...
		while (1)
		{
			...
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499, 
					&axis[0].pos[Wait_Pos], &axis[1].pos[Wait_Pos], &axis[2].pos[Wait_Pos], &axis[3].pos[Wait_Pos], &axis[4].pos[Wait_Pos], &axis[5].pos[Wait_Pos], 
					&axis[6].pos[Wait_Pos], &axis[7].pos[Wait_Pos], &axis[8].pos[Wait_Pos], &axis[9].pos[Wait_Pos], &axis[10].pos[Wait_Pos], &axis[11].pos[Wait_Pos],
					&axis[12].pos[Wait_Pos], &axis[13].pos[Wait_Pos], &axis[14].pos[Wait_Pos], &axis[15].pos[Wait_Pos], &axis[16].pos[Wait_Pos], &axis[17].pos[Wait_Pos],
					&axis[18].pos[Wait_Pos], &axis[19].pos[Wait_Pos], &axis[20].pos[Wait_Pos]);
			}
			else if (strcmp(Title, "MOTOR_LOADING_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,
					&axis[0].pos[Loading_Pos], &axis[1].pos[Loading_Pos], &axis[2].pos[Loading_Pos], &axis[3].pos[Loading_Pos], &axis[4].pos[Loading_Pos], &axis[5].pos[Loading_Pos], 
					&axis[6].pos[Loading_Pos], &axis[7].pos[Loading_Pos], &axis[8].pos[Loading_Pos], &axis[9].pos[Loading_Pos], &axis[10].pos[Loading_Pos], &axis[11].pos[Loading_Pos],
					&axis[12].pos[Loading_Pos], &axis[13].pos[Loading_Pos], &axis[14].pos[Loading_Pos], &axis[15].pos[Loading_Pos], &axis[16].pos[Loading_Pos], &axis[17].pos[Loading_Pos],
					&axis[18].pos[Loading_Pos], &axis[19].pos[Loading_Pos], &axis[20].pos[Loading_Pos]);
			}
			else if (strcmp(Title, "MOTOR_HOLDER_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,  
					&axis[0].pos[Holder_Pos], &axis[1].pos[Holder_Pos], &axis[2].pos[Holder_Pos], &axis[3].pos[Holder_Pos], &axis[4].pos[Holder_Pos], &axis[5].pos[Holder_Pos], 
					&axis[6].pos[Holder_Pos], &axis[7].pos[Holder_Pos], &axis[8].pos[Holder_Pos], &axis[9].pos[Holder_Pos], &axis[10].pos[Holder_Pos], &axis[11].pos[Holder_Pos],
					&axis[12].pos[Holder_Pos], &axis[13].pos[Holder_Pos], &axis[14].pos[Holder_Pos], &axis[15].pos[Holder_Pos], &axis[16].pos[Holder_Pos], &axis[17].pos[Holder_Pos],
					&axis[18].pos[Holder_Pos], &axis[19].pos[Holder_Pos], &axis[20].pos[Holder_Pos]);
			}
			else if (strcmp(Title, "MOTOR_DISPENSE_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499, 
					&axis[0].pos[Dispense_Pos], &axis[1].pos[Dispense_Pos], &axis[2].pos[Dispense_Pos], &axis[3].pos[Dispense_Pos], &axis[4].pos[Dispense_Pos], &axis[5].pos[Dispense_Pos], 
					&axis[6].pos[Dispense_Pos], &axis[7].pos[Dispense_Pos], &axis[8].pos[Dispense_Pos], &axis[9].pos[Dispense_Pos], &axis[10].pos[Dispense_Pos], &axis[11].pos[Dispense_Pos],
					&axis[12].pos[Dispense_Pos], &axis[13].pos[Dispense_Pos], &axis[14].pos[Dispense_Pos], &axis[15].pos[Dispense_Pos], &axis[16].pos[Dispense_Pos], &axis[17].pos[Dispense_Pos],
					&axis[18].pos[Dispense_Pos], &axis[19].pos[Dispense_Pos], &axis[20].pos[Dispense_Pos]);
			}
			else if (strcmp(Title, "MOTOR_LENS_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499, 
					&axis[0].pos[Lens_Pos], &axis[1].pos[Lens_Pos], &axis[2].pos[Lens_Pos], &axis[3].pos[Lens_Pos], &axis[4].pos[Lens_Pos], &axis[5].pos[Lens_Pos], 
					&axis[6].pos[Lens_Pos], &axis[7].pos[Lens_Pos], &axis[8].pos[Lens_Pos], &axis[9].pos[Lens_Pos], &axis[10].pos[Lens_Pos], &axis[11].pos[Lens_Pos],
					&axis[12].pos[Lens_Pos], &axis[13].pos[Lens_Pos], &axis[14].pos[Lens_Pos], &axis[15].pos[Lens_Pos], &axis[16].pos[Lens_Pos], &axis[17].pos[Lens_Pos],
					&axis[18].pos[Lens_Pos], &axis[19].pos[Lens_Pos], &axis[20].pos[Lens_Pos]);
			}
			else if (strcmp(Title, "MOTOR_LASER_PCB_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499, 
					&axis[0].pos[Laser_Pcb_Pos], &axis[1].pos[Laser_Pcb_Pos], &axis[2].pos[Laser_Pcb_Pos], &axis[3].pos[Laser_Pcb_Pos], &axis[4].pos[Laser_Pcb_Pos], &axis[5].pos[Laser_Pcb_Pos],
					&axis[6].pos[Laser_Pcb_Pos], &axis[7].pos[Laser_Pcb_Pos], &axis[8].pos[Laser_Pcb_Pos], &axis[9].pos[Laser_Pcb_Pos], &axis[10].pos[Laser_Pcb_Pos], &axis[11].pos[Laser_Pcb_Pos],
					&axis[12].pos[Laser_Pcb_Pos], &axis[13].pos[Laser_Pcb_Pos], &axis[14].pos[Laser_Pcb_Pos], &axis[15].pos[Laser_Pcb_Pos], &axis[16].pos[Laser_Pcb_Pos], &axis[17].pos[Laser_Pcb_Pos],
					&axis[18].pos[Laser_Pcb_Pos], &axis[19].pos[Laser_Pcb_Pos], &axis[20].pos[Laser_Pcb_Pos]);
			}
			else if (strcmp(Title, "MOTOR_LASER_LENS_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499, 
					&axis[0].pos[Laser_Lens_Pos], &axis[1].pos[Laser_Lens_Pos], &axis[2].pos[Laser_Lens_Pos], &axis[3].pos[Laser_Lens_Pos], &axis[4].pos[Laser_Lens_Pos], &axis[5].pos[Laser_Lens_Pos],
					&axis[6].pos[Laser_Lens_Pos], &axis[7].pos[Laser_Lens_Pos], &axis[8].pos[Laser_Lens_Pos], &axis[9].pos[Laser_Lens_Pos], &axis[10].pos[Laser_Lens_Pos], &axis[11].pos[Laser_Lens_Pos],
					&axis[12].pos[Laser_Lens_Pos], &axis[13].pos[Laser_Lens_Pos], &axis[14].pos[Laser_Lens_Pos], &axis[15].pos[Laser_Lens_Pos], &axis[16].pos[Laser_Lens_Pos], &axis[17].pos[Laser_Lens_Pos],
					&axis[18].pos[Laser_Lens_Pos], &axis[19].pos[Laser_Lens_Pos], &axis[20].pos[Laser_Lens_Pos]);
			}
			else if (strcmp(Title, "MOTOR_ALIGN_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499, 
					&axis[0].pos[Align_Pos], &axis[1].pos[Align_Pos], &axis[2].pos[Align_Pos], &axis[3].pos[Align_Pos], &axis[4].pos[Align_Pos], &axis[5].pos[Align_Pos], 
					&axis[6].pos[Align_Pos], &axis[7].pos[Align_Pos], &axis[8].pos[Align_Pos], &axis[9].pos[Align_Pos], &axis[10].pos[Align_Pos], &axis[11].pos[Align_Pos],
					&axis[12].pos[Align_Pos], &axis[13].pos[Align_Pos], &axis[14].pos[Align_Pos], &axis[15].pos[Align_Pos], &axis[16].pos[Align_Pos], &axis[17].pos[Align_Pos],
					&axis[18].pos[Align_Pos], &axis[19].pos[Align_Pos], &axis[20].pos[Align_Pos]);
			}
			else if (strcmp(Title, "MOTOR_BONDING_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,  
					&axis[0].pos[Bonding_Pos], &axis[1].pos[Bonding_Pos], &axis[2].pos[Bonding_Pos], &axis[3].pos[Bonding_Pos], &axis[4].pos[Bonding_Pos], &axis[5].pos[Bonding_Pos], 
					&axis[6].pos[Bonding_Pos], &axis[7].pos[Bonding_Pos], &axis[8].pos[Bonding_Pos], &axis[9].pos[Bonding_Pos], &axis[10].pos[Bonding_Pos], &axis[11].pos[Bonding_Pos],
					&axis[12].pos[Bonding_Pos], &axis[13].pos[Bonding_Pos], &axis[14].pos[Bonding_Pos], &axis[15].pos[Bonding_Pos], &axis[16].pos[Bonding_Pos], &axis[17].pos[Bonding_Pos],
					&axis[18].pos[Bonding_Pos], &axis[19].pos[Bonding_Pos], &axis[20].pos[Bonding_Pos]);
			}
			else if (strcmp(Title, "MOTOR_DARK_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,  
					&axis[0].pos[Dark_Pos], &axis[1].pos[Dark_Pos], &axis[2].pos[Dark_Pos], &axis[3].pos[Dark_Pos], &axis[4].pos[Dark_Pos], &axis[5].pos[Dark_Pos], 
					&axis[6].pos[Dark_Pos], &axis[7].pos[Dark_Pos], &axis[8].pos[Dark_Pos], &axis[9].pos[Dark_Pos], &axis[10].pos[Dark_Pos], &axis[11].pos[Dark_Pos],
					&axis[12].pos[Dark_Pos], &axis[13].pos[Dark_Pos], &axis[14].pos[Dark_Pos], &axis[15].pos[Dark_Pos], &axis[16].pos[Dark_Pos], &axis[17].pos[Dark_Pos],
					&axis[18].pos[Dark_Pos], &axis[19].pos[Dark_Pos], &axis[20].pos[Dark_Pos]);
			}
            else if (strcmp(Title, "MOTOR_6500K_POSITION") == 0)
            {
                sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,
                    &axis[0].pos[OC_6500K_Pos], &axis[1].pos[OC_6500K_Pos], &axis[2].pos[OC_6500K_Pos], &axis[3].pos[OC_6500K_Pos], &axis[4].pos[OC_6500K_Pos], &axis[5].pos[OC_6500K_Pos],
                    &axis[6].pos[OC_6500K_Pos], &axis[7].pos[OC_6500K_Pos], &axis[8].pos[OC_6500K_Pos], &axis[9].pos[OC_6500K_Pos], &axis[10].pos[OC_6500K_Pos], &axis[11].pos[OC_6500K_Pos],
					&axis[12].pos[OC_6500K_Pos], &axis[13].pos[OC_6500K_Pos], &axis[14].pos[OC_6500K_Pos], &axis[15].pos[OC_6500K_Pos], &axis[16].pos[OC_6500K_Pos], &axis[17].pos[OC_6500K_Pos],
					&axis[18].pos[OC_6500K_Pos], &axis[19].pos[OC_6500K_Pos], &axis[20].pos[OC_6500K_Pos]);
            }
            else if (strcmp(Title, "MOTOR_2800K_POSITION") == 0)
            {
                sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,
                    &axis[0].pos[OC_2800K_Pos], &axis[1].pos[OC_2800K_Pos], &axis[2].pos[OC_2800K_Pos], &axis[3].pos[OC_2800K_Pos], &axis[4].pos[OC_2800K_Pos], &axis[5].pos[OC_2800K_Pos],
                    &axis[6].pos[OC_2800K_Pos], &axis[7].pos[OC_2800K_Pos], &axis[8].pos[OC_2800K_Pos], &axis[9].pos[OC_2800K_Pos], &axis[10].pos[OC_2800K_Pos], &axis[11].pos[OC_2800K_Pos],
					&axis[12].pos[OC_2800K_Pos], &axis[13].pos[OC_2800K_Pos], &axis[14].pos[OC_2800K_Pos], &axis[15].pos[OC_2800K_Pos], &axis[16].pos[OC_2800K_Pos], &axis[17].pos[OC_2800K_Pos],
					&axis[18].pos[OC_2800K_Pos], &axis[19].pos[OC_2800K_Pos], &axis[20].pos[OC_2800K_Pos]);
            }
			else if (strcmp(Title, "MOTOR_DEFECT_POSITION") == 0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,
					&axis[0].pos[Defect_Pos], &axis[1].pos[Defect_Pos], &axis[2].pos[Defect_Pos], &axis[3].pos[Defect_Pos], &axis[4].pos[Defect_Pos], &axis[5].pos[Defect_Pos],
					&axis[6].pos[Defect_Pos], &axis[7].pos[Defect_Pos], &axis[8].pos[Defect_Pos], &axis[9].pos[Defect_Pos], &axis[10].pos[Defect_Pos], &axis[11].pos[Defect_Pos],
					&axis[12].pos[Defect_Pos], &axis[13].pos[Defect_Pos], &axis[14].pos[Defect_Pos], &axis[15].pos[Defect_Pos], &axis[16].pos[Defect_Pos], &axis[17].pos[Defect_Pos],
					&axis[18].pos[Defect_Pos], &axis[19].pos[Defect_Pos], &axis[20].pos[Defect_Pos]);
			}
			else if (strcmp(Title, "MOTOR_PCB_LOADING_POSITION") == 0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,
					&axis[0].pos[Pcb_Loading_Pos], &axis[1].pos[Pcb_Loading_Pos], &axis[2].pos[Pcb_Loading_Pos], &axis[3].pos[Pcb_Loading_Pos], &axis[4].pos[Pcb_Loading_Pos], &axis[5].pos[Pcb_Loading_Pos],
					&axis[6].pos[Pcb_Loading_Pos], &axis[7].pos[Pcb_Loading_Pos], &axis[8].pos[Pcb_Loading_Pos], &axis[9].pos[Pcb_Loading_Pos], &axis[10].pos[Pcb_Loading_Pos], &axis[11].pos[Pcb_Loading_Pos],
					&axis[12].pos[Pcb_Loading_Pos], &axis[13].pos[Pcb_Loading_Pos], &axis[14].pos[Pcb_Loading_Pos], &axis[15].pos[Pcb_Loading_Pos], &axis[16].pos[Pcb_Loading_Pos], &axis[17].pos[Pcb_Loading_Pos],
					&axis[18].pos[Pcb_Loading_Pos], &axis[19].pos[Pcb_Loading_Pos], &axis[20].pos[Pcb_Loading_Pos]);
			}
			else if (strcmp(Title, "MOTOR_COVER_LOADING_POSITION") == 0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,
					&axis[0].pos[Cover_Loading_Pos], &axis[1].pos[Cover_Loading_Pos], &axis[2].pos[Cover_Loading_Pos], &axis[3].pos[Cover_Loading_Pos], &axis[4].pos[Cover_Loading_Pos], &axis[5].pos[Cover_Loading_Pos],
					&axis[6].pos[Cover_Loading_Pos], &axis[7].pos[Cover_Loading_Pos], &axis[8].pos[Cover_Loading_Pos], &axis[9].pos[Cover_Loading_Pos], &axis[10].pos[Cover_Loading_Pos], &axis[11].pos[Cover_Loading_Pos],
					&axis[12].pos[Cover_Loading_Pos], &axis[13].pos[Cover_Loading_Pos], &axis[14].pos[Cover_Loading_Pos], &axis[15].pos[Cover_Loading_Pos], &axis[16].pos[Cover_Loading_Pos], &axis[17].pos[Cover_Loading_Pos],
					&axis[18].pos[Cover_Loading_Pos], &axis[19].pos[Cover_Loading_Pos], &axis[20].pos[Cover_Loading_Pos]);
			}
			else if (strcmp(Title, "MOTOR_COVER_UNLOADING_POSITION") == 0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,
					&axis[0].pos[Cover_UnLoading_Pos], &axis[1].pos[Cover_UnLoading_Pos], &axis[2].pos[Cover_UnLoading_Pos], &axis[3].pos[Cover_UnLoading_Pos], &axis[4].pos[Cover_UnLoading_Pos], &axis[5].pos[Cover_UnLoading_Pos],
					&axis[6].pos[Cover_UnLoading_Pos], &axis[7].pos[Cover_UnLoading_Pos], &axis[8].pos[Cover_UnLoading_Pos], &axis[9].pos[Cover_UnLoading_Pos], &axis[10].pos[Cover_UnLoading_Pos], &axis[11].pos[Cover_UnLoading_Pos],
					&axis[12].pos[Cover_UnLoading_Pos], &axis[13].pos[Cover_UnLoading_Pos], &axis[14].pos[Cover_UnLoading_Pos], &axis[15].pos[Cover_UnLoading_Pos], &axis[16].pos[Cover_UnLoading_Pos], &axis[17].pos[Cover_UnLoading_Pos],
					&axis[18].pos[Cover_UnLoading_Pos], &axis[19].pos[Cover_UnLoading_Pos], &axis[20].pos[Cover_UnLoading_Pos]);
			}
			//
			//
			else if (strcmp(Title, "MOTOR_POINT_DISPENSE_POSITION") == 0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,
					&axis[0].pos[PDispense_Pos], &axis[1].pos[PDispense_Pos], &axis[2].pos[PDispense_Pos], &axis[3].pos[PDispense_Pos], &axis[4].pos[PDispense_Pos], &axis[5].pos[PDispense_Pos],
					&axis[6].pos[PDispense_Pos], &axis[7].pos[PDispense_Pos], &axis[8].pos[PDispense_Pos], &axis[9].pos[PDispense_Pos], &axis[10].pos[PDispense_Pos], &axis[11].pos[PDispense_Pos],
					&axis[12].pos[PDispense_Pos], &axis[13].pos[PDispense_Pos], &axis[14].pos[PDispense_Pos], &axis[15].pos[PDispense_Pos], &axis[16].pos[PDispense_Pos], &axis[17].pos[PDispense_Pos],
					&axis[18].pos[PDispense_Pos], &axis[19].pos[PDispense_Pos], &axis[20].pos[PDispense_Pos]);
			}
			else if (strcmp(Title, "MOTOR_CONNECT_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,  
					&axis[0].pos[Contact_Pos], &axis[1].pos[Contact_Pos], &axis[2].pos[Contact_Pos], &axis[3].pos[Contact_Pos], &axis[4].pos[Contact_Pos], &axis[5].pos[Contact_Pos], 
					&axis[6].pos[Contact_Pos], &axis[7].pos[Contact_Pos], &axis[8].pos[Contact_Pos], &axis[9].pos[Contact_Pos], &axis[10].pos[Contact_Pos], &axis[11].pos[Contact_Pos],
					&axis[12].pos[Contact_Pos], &axis[13].pos[Contact_Pos], &axis[14].pos[Contact_Pos], &axis[15].pos[Contact_Pos], &axis[16].pos[Contact_Pos], &axis[17].pos[Contact_Pos],
					&axis[18].pos[Contact_Pos], &axis[19].pos[Contact_Pos], &axis[20].pos[Contact_Pos]);
			}
			else if (strcmp(Title, "MOTOR_CALC_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,  
					&axis[0].pos[Calc_Pos], &axis[1].pos[Calc_Pos], &axis[2].pos[Calc_Pos], &axis[3].pos[Calc_Pos], &axis[4].pos[Calc_Pos], &axis[5].pos[Calc_Pos], 
					&axis[6].pos[Calc_Pos], &axis[7].pos[Calc_Pos], &axis[8].pos[Calc_Pos], &axis[9].pos[Calc_Pos], &axis[10].pos[Calc_Pos], &axis[11].pos[Calc_Pos],
					&axis[12].pos[Calc_Pos], &axis[13].pos[Calc_Pos], &axis[14].pos[Calc_Pos], &axis[15].pos[Calc_Pos], &axis[16].pos[Calc_Pos], &axis[17].pos[Calc_Pos],
					&axis[18].pos[Calc_Pos], &axis[19].pos[Calc_Pos], &axis[20].pos[Calc_Pos]);
			}
			else if (strcmp(Title, "MOTOR_CLEAN_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,  
					&axis[0].pos[Clean_Pos], &axis[1].pos[Clean_Pos], &axis[2].pos[Clean_Pos], &axis[3].pos[Clean_Pos], &axis[4].pos[Clean_Pos], &axis[5].pos[Clean_Pos], 
					&axis[6].pos[Clean_Pos], &axis[7].pos[Clean_Pos], &axis[8].pos[Clean_Pos], &axis[9].pos[Clean_Pos], &axis[10].pos[Clean_Pos], &axis[11].pos[Clean_Pos],
					&axis[12].pos[Clean_Pos], &axis[13].pos[Clean_Pos], &axis[14].pos[Clean_Pos], &axis[15].pos[Clean_Pos], &axis[16].pos[Clean_Pos], &axis[17].pos[Clean_Pos],
					&axis[18].pos[Clean_Pos], &axis[19].pos[Clean_Pos], &axis[20].pos[Clean_Pos]);
			}
			else if (strcmp(Title, "MOTOR_INSP_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,  
					&axis[0].pos[Insp_Pos], &axis[1].pos[Insp_Pos], &axis[2].pos[Insp_Pos], &axis[3].pos[Insp_Pos], &axis[4].pos[Insp_Pos], &axis[5].pos[Insp_Pos], 
					&axis[6].pos[Insp_Pos], &axis[7].pos[Insp_Pos], &axis[8].pos[Insp_Pos], &axis[9].pos[Insp_Pos], &axis[10].pos[Insp_Pos], &axis[11].pos[Insp_Pos],
					&axis[12].pos[Insp_Pos], &axis[13].pos[Insp_Pos], &axis[14].pos[Insp_Pos], &axis[15].pos[Insp_Pos], &axis[16].pos[Insp_Pos], &axis[17].pos[Insp_Pos],
					&axis[18].pos[Insp_Pos], &axis[19].pos[Insp_Pos], &axis[20].pos[Insp_Pos]);
			}
			else if (strcmp(Title, "MOTOR_HOLDER_UV_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,  
					&axis[0].pos[Holder_Uv_Pos], &axis[1].pos[Holder_Uv_Pos], &axis[2].pos[Holder_Uv_Pos], &axis[3].pos[Holder_Uv_Pos], &axis[4].pos[Holder_Uv_Pos], &axis[5].pos[Holder_Uv_Pos],
					&axis[6].pos[Holder_Uv_Pos], &axis[7].pos[Holder_Uv_Pos], &axis[8].pos[Holder_Uv_Pos], &axis[9].pos[Holder_Uv_Pos], &axis[10].pos[Holder_Uv_Pos], &axis[11].pos[Holder_Uv_Pos],
					&axis[12].pos[Holder_Uv_Pos], &axis[13].pos[Holder_Uv_Pos], &axis[14].pos[Holder_Uv_Pos], &axis[15].pos[Holder_Uv_Pos], &axis[16].pos[Holder_Uv_Pos], &axis[17].pos[Holder_Uv_Pos],
					&axis[18].pos[Holder_Uv_Pos], &axis[19].pos[Holder_Uv_Pos], &axis[20].pos[Holder_Uv_Pos]);
			}
			else if (strcmp(Title, "MOTOR_CONTI_TAIL_DELAY_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,  
					&axis[0].pos[ContiTailDelay_Pos], &axis[1].pos[ContiTailDelay_Pos], &axis[2].pos[ContiTailDelay_Pos], &axis[3].pos[ContiTailDelay_Pos], &axis[4].pos[ContiTailDelay_Pos], &axis[5].pos[ContiTailDelay_Pos],
					&axis[6].pos[ContiTailDelay_Pos], &axis[7].pos[ContiTailDelay_Pos], &axis[8].pos[ContiTailDelay_Pos], &axis[9].pos[ContiTailDelay_Pos], &axis[10].pos[ContiTailDelay_Pos], &axis[11].pos[ContiTailDelay_Pos],
					&axis[12].pos[ContiTailDelay_Pos], &axis[13].pos[ContiTailDelay_Pos], &axis[14].pos[ContiTailDelay_Pos], &axis[15].pos[ContiTailDelay_Pos], &axis[16].pos[ContiTailDelay_Pos], &axis[17].pos[ContiTailDelay_Pos],
					&axis[18].pos[ContiTailDelay_Pos], &axis[19].pos[ContiTailDelay_Pos], &axis[20].pos[ContiTailDelay_Pos]);
			}
			else if (strcmp(Title, "MOTOR_COM_LASER_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,  
					&axis[0].pos[Com_Laser_Pos], &axis[1].pos[Com_Laser_Pos], &axis[2].pos[Com_Laser_Pos], &axis[3].pos[Com_Laser_Pos], &axis[4].pos[Com_Laser_Pos], &axis[5].pos[Com_Laser_Pos],
					&axis[6].pos[Com_Laser_Pos], &axis[7].pos[Com_Laser_Pos], &axis[8].pos[Com_Laser_Pos], &axis[9].pos[Com_Laser_Pos], &axis[10].pos[Com_Laser_Pos], &axis[11].pos[Com_Laser_Pos],
					&axis[12].pos[Com_Laser_Pos], &axis[13].pos[Com_Laser_Pos], &axis[14].pos[Com_Laser_Pos], &axis[15].pos[Com_Laser_Pos], &axis[16].pos[Com_Laser_Pos], &axis[17].pos[Com_Laser_Pos],
					&axis[18].pos[Com_Laser_Pos], &axis[19].pos[Com_Laser_Pos], &axis[20].pos[Com_Laser_Pos]);
			}
			else if (strcmp(Title, "MOTOR_CALC2_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,  
					&axis[0].pos[Calc2_Pos], &axis[1].pos[Calc2_Pos], &axis[2].pos[Calc2_Pos], &axis[3].pos[Calc2_Pos], &axis[4].pos[Calc2_Pos], &axis[5].pos[Calc2_Pos], 
					&axis[6].pos[Calc2_Pos], &axis[7].pos[Calc2_Pos], &axis[8].pos[Calc2_Pos], &axis[9].pos[Calc2_Pos], &axis[10].pos[Calc2_Pos], &axis[11].pos[Calc2_Pos],
					&axis[12].pos[Calc2_Pos], &axis[13].pos[Calc2_Pos], &axis[14].pos[Calc2_Pos], &axis[15].pos[Calc2_Pos], &axis[16].pos[Calc2_Pos], &axis[17].pos[Calc2_Pos],
					&axis[18].pos[Calc2_Pos], &axis[19].pos[Calc2_Pos], &axis[20].pos[Calc2_Pos]);
			}
			else if (strcmp(Title, "MOTOR_COMALIGN_POSITION")==0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,  
					&axis[0].pos[CompleteAlign_Pos], &axis[1].pos[CompleteAlign_Pos], &axis[2].pos[CompleteAlign_Pos], &axis[3].pos[CompleteAlign_Pos], &axis[4].pos[CompleteAlign_Pos], &axis[5].pos[CompleteAlign_Pos], 
					&axis[6].pos[CompleteAlign_Pos], &axis[7].pos[CompleteAlign_Pos], &axis[8].pos[CompleteAlign_Pos], &axis[9].pos[CompleteAlign_Pos], &axis[10].pos[CompleteAlign_Pos], &axis[11].pos[CompleteAlign_Pos],
					&axis[12].pos[CompleteAlign_Pos], &axis[13].pos[CompleteAlign_Pos], &axis[14].pos[CompleteAlign_Pos], &axis[15].pos[CompleteAlign_Pos], &axis[16].pos[CompleteAlign_Pos], &axis[17].pos[CompleteAlign_Pos],
					&axis[18].pos[CompleteAlign_Pos], &axis[19].pos[CompleteAlign_Pos], &axis[20].pos[CompleteAlign_Pos]);
			}
			else if (strcmp(Title, "MOTOR_DISPENSE_POS1") == 0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,
					&axis[0].pos[Dispense_Pos1], &axis[1].pos[Dispense_Pos1], &axis[2].pos[Dispense_Pos1], &axis[3].pos[Dispense_Pos1], &axis[4].pos[Dispense_Pos1], &axis[5].pos[Dispense_Pos1],
					&axis[6].pos[Dispense_Pos1], &axis[7].pos[Dispense_Pos1], &axis[8].pos[Dispense_Pos1], &axis[9].pos[Dispense_Pos1], &axis[10].pos[Dispense_Pos1], &axis[11].pos[Dispense_Pos1],
					&axis[12].pos[Dispense_Pos1], &axis[13].pos[Dispense_Pos1], &axis[14].pos[Dispense_Pos1], &axis[15].pos[Dispense_Pos1], &axis[16].pos[Dispense_Pos1], &axis[17].pos[Dispense_Pos1],
					&axis[18].pos[Dispense_Pos1], &axis[19].pos[Dispense_Pos1], &axis[20].pos[Dispense_Pos1]);
			}
			...
			else if (strcmp(Title, "MOTOR_DISPENSE_POS2") == 0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,
					&axis[0].pos[Dispense_Pos2], &axis[1].pos[Dispense_Pos2], &axis[2].pos[Dispense_Pos2], &axis[3].pos[Dispense_Pos2], &axis[4].pos[Dispense_Pos2], &axis[5].pos[Dispense_Pos2],
					&axis[6].pos[Dispense_Pos2], &axis[7].pos[Dispense_Pos2], &axis[8].pos[Dispense_Pos2], &axis[9].pos[Dispense_Pos2], &axis[10].pos[Dispense_Pos2], &axis[11].pos[Dispense_Pos2],
					&axis[12].pos[Dispense_Pos2], &axis[13].pos[Dispense_Pos2], &axis[14].pos[Dispense_Pos2], &axis[15].pos[Dispense_Pos2], &axis[16].pos[Dispense_Pos2], &axis[17].pos[Dispense_Pos2],
					&axis[18].pos[Dispense_Pos2], &axis[19].pos[Dispense_Pos2], &axis[20].pos[Dispense_Pos2]);
			}
			...
			else if (strcmp(Title, "MOTOR_DISPENSE_POS3") == 0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf %lf", Title, 499,
					&axis[0].pos[Dispense_Pos3], &axis[1].pos[Dispense_Pos3], &axis[2].pos[Dispense_Pos3], &axis[3].pos[Dispense_Pos3], &axis[4].pos[Dispense_Pos3], &axis[5].pos[Dispense_Pos3],
					&axis[6].pos[Dispense_Pos3], &axis[7].pos[Dispense_Pos3], &axis[8].pos[Dispense_Pos3], &axis[9].pos[Dispense_Pos3], &axis[10].pos[Dispense_Pos3], &axis[11].pos[Dispense_Pos3],
					&axis[12].pos[Dispense_Pos3], &axis[13].pos[Dispense_Pos3], &axis[14].pos[Dispense_Pos3], &axis[15].pos[Dispense_Pos3], &axis[16].pos[Dispense_Pos3], &axis[17].pos[Dispense_Pos3],
					&axis[18].pos[Dispense_Pos3], &axis[19].pos[Dispense_Pos3], &axis[20].pos[Dispense_Pos3]);
			}
			else if (strcmp(Title, "LENS_OK_LIMIT") == 0)
			{
			...
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf"
					, Title, 499, &axis[Motor_PCB_X].m_dLimit_OK, &axis[Motor_PCB_Y].m_dLimit_OK, &axis[Motor_PCB_Z].m_dLimit_OK,
					&axis[Motor_PCB_TH].m_dLimit_OK, &axis[Motor_PCB_Xt].m_dLimit_OK, &axis[Motor_PCB_Yt].m_dLimit_OK, &axis[Motor_Insp_X].m_dLimit_OK);
			}
			else if (strcmp(Title, "PCB_ERR_LIMIT") == 0)
			{
				sscanf_s(Line, "%s %lf %lf %lf %lf %lf %lf %lf"
					, Title, 499, &axis[Motor_PCB_X].m_dLimit_Err, &axis[Motor_PCB_Y].m_dLimit_Err, &axis[Motor_PCB_Z].m_dLimit_Err,
					&axis[Motor_PCB_TH].m_dLimit_Err, &axis[Motor_PCB_Xt].m_dLimit_Err, &axis[Motor_PCB_Yt].m_dLimit_Err, &axis[Motor_Insp_X].m_dLimit_Err);
			}
#endif
...
void CMandoInspLog::func_InitData()
{
	...
	for(iNo = 0; iNo < COMMON_MTF_INSP_CNT; iNo++)
	{
		dMTF_PreUV[iNo] = 0.0;
		dMTF_PostUV[iNo] = 0.0;
		m_ChartVertex[iNo].Pos[0] = 0;
		m_ChartVertex[iNo].Pos[1] = 0;
		m_ChartVertex[iNo].Pos[2] = 0;
		m_ChartVertex[iNo].Pos[3] = 0;
	}
...
void CMandoInspLog::func_LogSave_Shm_vertex()		//UVBefore_AA시 로그  로그대대적수정(2/5)
{
	CAABonderDlg* pFrame = (CAABonderDlg*)AfxGetApp()->m_pMainWnd;
	FILE *out;
	int i = 0;
	...
	char fileName[1000];
	wsprintf(fileName, "%s\\%04d%02d%02d_EolLog_Vertex.csv", FolderName, Insptime.wYear, Insptime.wMonth, Insptime.wDay, sysData.m_iSystemNo, sysData.m_iUnitNo);
	...
	/*TCHAR* pszCol[] = { _T("TOP_CHART_CENTER_LT"), _T("TOP_CHART_CENTER_RB")
		, _T("TOP_CHART_LT") , _T("TOP_CHART_RT") , _T("TOP_CHART_LB") , _T("TOP_CHART_RB")
		, _T("LEFT_SIDE_CHART_T") , _T("LEFT_SIDE_CHART_M") , _T("LEFT_SIDE_CHART_B") 
		, _T("RIGHT_SIDE_CHART_T") , _T("RIGHT_SIDE_CHART_M") , _T("RIGHT_SIDE_CHART_B") };*/

	//TCHAR* pszCol[] = { 
	//	_T("TOP_CHART_LT_lt") ,_T("TOP_CHART_LT_rb") , 
	//	_T("TOP_CHART_RT_lb") ,_T("TOP_CHART_RT_rt") ,
	//	_T("TOP_CHART_LB_lb") ,_T("TOP_CHART_LB_rt") ,
	//	_T("TOP_CHART_RB_lt"),_T("TOP_CHART_RB_rb"),
	//	//
	//	_T("LEFT_SIDE_CHART_T_l") ,_T("LEFT_SIDE_CHART_T_r") ,
	//	_T("LEFT_SIDE_CHART_M_l") ,_T("LEFT_SIDE_CHART_M_r") ,
	//	_T("LEFT_SIDE_CHART_B_l"),_T("LEFT_SIDE_CHART_B_r") ,
	//	//
	//	_T("RIGHT_SIDE_CHART_T_l") ,_T("RIGHT_SIDE_CHART_T_r") ,
	//	_T("RIGHT_SIDE_CHART_M_l") ,_T("RIGHT_SIDE_CHART_M_r") ,
	//	_T("RIGHT_SIDE_CHART_B_l") ,_T("RIGHT_SIDE_CHART_B_r")
	//};
	...
	if (fopen_s(&out, fileName, "r") != NULL)
	{
		if (fopen_s(&out, fileName, "w") == NULL)
		{
			...
			for (i = 0; i < roiCount; i++)
			{
				...
				if (count2 - count1 > 1 && count1 > 0)
				{
					_ftprintf_s(out, _T("%s"), pszCol[i]);
				}
				else
				{
					_ftprintf_s(out, _T("%s"), pszCol150[i]);
				}
			}
			fprintf_s(out, "\n");
			//
	...
	if (!fopen_s(&out, fileName, "a"))
	{
		...
		{
			//TOP CHART
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[1].Pos[1].x, MandoInspLog.m_ChartVertex[1].Pos[1].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[1].Pos[7].x, MandoInspLog.m_ChartVertex[1].Pos[7].y);

			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[2].Pos[0].x, MandoInspLog.m_ChartVertex[2].Pos[0].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[2].Pos[7].x, MandoInspLog.m_ChartVertex[2].Pos[7].y);

			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[3].Pos[0].x, MandoInspLog.m_ChartVertex[3].Pos[0].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[3].Pos[7].x, MandoInspLog.m_ChartVertex[3].Pos[7].y);

			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[4].Pos[1].x, MandoInspLog.m_ChartVertex[4].Pos[1].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[4].Pos[7].x, MandoInspLog.m_ChartVertex[4].Pos[7].y);
			//LEFT SIDE CHART
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[5].Pos[0].x, MandoInspLog.m_ChartVertex[5].Pos[0].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[7].Pos[1].x, MandoInspLog.m_ChartVertex[7].Pos[1].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[11].Pos[3].x, MandoInspLog.m_ChartVertex[11].Pos[3].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[13].Pos[2].x, MandoInspLog.m_ChartVertex[13].Pos[2].y);
			//RIGHT SIDE CHART
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[6].Pos[2].x, MandoInspLog.m_ChartVertex[6].Pos[2].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[8].Pos[3].x, MandoInspLog.m_ChartVertex[8].Pos[3].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[12].Pos[1].x, MandoInspLog.m_ChartVertex[12].Pos[1].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[14].Pos[0].x, MandoInspLog.m_ChartVertex[14].Pos[0].y);
		}
		else
		{
			//LEFT SIDE
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[11].Pos[1].x, MandoInspLog.m_ChartVertex[11].Pos[1].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[11].Pos[2].x, MandoInspLog.m_ChartVertex[11].Pos[2].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[13].Pos[0].x, MandoInspLog.m_ChartVertex[13].Pos[0].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[13].Pos[3].x, MandoInspLog.m_ChartVertex[13].Pos[3].y);

			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[5].Pos[1].x, MandoInspLog.m_ChartVertex[5].Pos[1].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[15].Pos[0].x, MandoInspLog.m_ChartVertex[15].Pos[0].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[7].Pos[0].x, MandoInspLog.m_ChartVertex[7].Pos[0].y);

			//RIGHT SIDE
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[12].Pos[0].x, MandoInspLog.m_ChartVertex[12].Pos[0].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[12].Pos[3].x, MandoInspLog.m_ChartVertex[12].Pos[3].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[14].Pos[1].x, MandoInspLog.m_ChartVertex[14].Pos[1].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[14].Pos[2].x, MandoInspLog.m_ChartVertex[14].Pos[2].y);

			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[6].Pos[3].x, MandoInspLog.m_ChartVertex[6].Pos[3].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[16].Pos[3].x, MandoInspLog.m_ChartVertex[16].Pos[3].y);
			fprintf_s(out, "%d,%d,", MandoInspLog.m_ChartVertex[8].Pos[2].x, MandoInspLog.m_ChartVertex[8].Pos[2].y);
		}
